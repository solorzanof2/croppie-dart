...
class BindConfiguration {
  external factory BindConfiguration({String url, List<String> points, int orientation, double zoom});
...
class CroppieJS implements CroppieBase {
  ...
  external Promise result(String type, String size, String format, int quality, bool circle);
